...
public class Main {
    ...
    public static void main(String[] args) {
        String[][] board = new String[LENGTH_BOARD][LENGTH_BOARD];
        String[][] board2 = new String[LENGTH_BOARD][LENGTH_BOARD];
        String[][] fakeBoard = new String[LENGTH_BOARD][LENGTH_BOARD];
        String[][] fakeBoard2 = new String[LENGTH_BOARD][LENGTH_BOARD];
        String[] legendas = new String[]{"null", "null", "[ ~ ] - Mar\n", "[ X ] - Alvo atingido\n", "[ S ] - Submarino\n", "[ F ] - Fragata\n", "[ C ] - Corveta\n", "[ D ] - Destroyer\n", "null", "null"};
        boolean vez = true;
        boolean playing = true;
        boolean changeMode = true;
        boolean positionShips = true;
        String submarino = "S";
        String fragata = "F";
        String corveta = "C";
        String destroyer = "D";
        ...
        int[] numberOfShips = new int[]{5, 3, 2, 2};
        int[] lengthOfShips = new int[]{1, 2, 3, 4};
        int points = 0;
        int points2 = 0;
